...
var hiro = {
  ...
  age: "26",
  education: [
    { institution: "Sorocaba Technological College (FATEC)", status: "in progress", name: "System Analysis and Development - Information Technology" },
    { institution: "University of Campinas (UNICAMP)", status: "in progress", name: "Masters in Electrical Engineering"},
    { institution: "Sorocaba College of Engineering (FACENS)", status: "finished", name: "Bachelor in Electrical Engineering"},
    { institution: "TOkyo University of Electrical Communications (UEC)", status: "finished", name: "Sandwich degree"},
  ],
  work: [
    { company: "FIT - Institute of Technology", period: "2019/01 ~ NOW", experience: "C/C++, Python, Batch" },
    { company: "VA Engenharia", period: "2018/03 ~ 2019/01", experience: "PHP, MySQL, jQuery, JavaScript, HTML, SASS, Python Flask" },
  ]
...
window.onload = () => {
  ...
  fetch('https://api.github.com/users/brunoanhaia/repos')
    ...
    resume__wrapper__pre.innerHTML = JSON.stringify(hiro, null, '  ');

/*     Object.keys(hiro).forEach((key)=> {
      hiro[key].forEach((element)=> {
